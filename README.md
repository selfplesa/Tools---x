...
[![Build Status](https://img.shields.io/github/forks/selfplesa/Tools---x.git)](https://github.com/selfplesa/Tools---x.git)
[![Build Status](https://img.shields.io/github/stars/selfplesa/Tools---x.git)](https://github.com/selfplesa/Tools---x.git)
[![License](https://img.shields.io/github/license/selfplesa/Tools---x.git)](https://github.com/selfplesa/Tools---x.git)
...
*A similar lightweight and fast tool [onex]https://github.com/selfplesa/Tools---x.git) is available. We can use onex instead of Tool-X*
...
* `git clone https://github.com/selfplesa/Tools---x.git
